export default function HomepageHero() {
  return (
    <section className="h-screen sm:pb-20 bg-slate-200 dark:bg-black">
      <div className="h-full flex flex-col lg:flex-row items-center justify-center relative max-w-screen-xl mx-auto overflow-hidden px-4 pb-12 md:pb-0 md:px-8">
        {/* Text Section */}
