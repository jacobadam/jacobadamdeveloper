export default function HomepageHero() {
  return (
    <section className="bg-slate-200">
      <div className="max-w-screen-xl mx-auto px-4 pt-8 pb-16 md:py-16 lg:pt-4 lg:pb-44 xl:pt-8 xl:pb-56 2xl:pb-72 2xl:pt-32 text-gray-600 overflow-hidden md:px-8 flex flex-col lg:flex-row">
        {/* Text Section */}
