            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute inset-0 z-0 bg-gradient-to-br from-indigo-500 via-indigo-500/0 to-indigo-500 opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                />
              </div>
            ))}
          </div>
